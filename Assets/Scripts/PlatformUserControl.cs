...
public class PlatformUserControl : MonoBehaviour {
	...
	**/
	...
	void Start() {
		bool ok = true;
		if(prefabAnalogStickTexture != null)
		{
...
//			Debug.LogWarning(this.ToString() +": is reading local controls input!!!");
	...
	void FixedUpdate()
	{
		translation = new Vector3(inputHorizontal*speed,
		                          inputVertical*speed,
		                          0);
		this.rigidbody.AddForce(translation);
...
//		}
		...
		inputVertical = inputTouchVertical + inputKeyboardVertical;
